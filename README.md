...
`<git clone https://github.com/davijose40/Rocketseat-desafio-node-fundamentos.git>`, then in the folder **Rocketseat-Gostack-Node-Concept*** run `<yarn>` and you are good to go!
